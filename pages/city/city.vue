		...
		<view class="VerticalBox">
			...
			<scroll-view class="VerticalMain" scroll-y scroll-with-animation style=""
			 :scroll-into-view="'main-'+mainCur" @scroll="VerticalMain">
				<view class="padding-top padding-lr" v-for="(item,index) in list" :key="index" :id="'main-'+index" style="height:calc(100vh - 375upx)">
					<view class="cu-bar solid-bottom bg-white">
						<view class="action">
							<text class="cuIcon-title text-green"></text> {{item.name}}</view>
					</view>
					<view class="cu-list menu-avatar">
						<view class="cu-item" v-for="(city,index) in item.area" :key="index" :id="'main-'+index" >
...
<script>
	import citydata from '../../static/city.js'
	export default {
		name: 'city',
		data() {
			return {
