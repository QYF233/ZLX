...
<script>
	import foods from '../../static/foodsPic.js'
	export default {
		name: 'Food',
		props:{
			city:String
		...
		methods: {
			...
			getCityFood(){
				...
				for (var i = 0; i < this.foodsPic; i++) {
					console.log("222"+this.foodsPic[i].name);
					if(this.foodsPic[i].name = this.city){
						this.photoList = this.foodsPic[i].foodPic;
					}
				}
			},
			/* 获取照片 */
