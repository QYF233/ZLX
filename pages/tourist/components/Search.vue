<template>
	<view class="content">
		...
		<form @submit="formSubmit" @reset="formReset">
			...
			<view class="option-100">
				<view class="button-mini">
					<button type="primary" form-type="submit" size="mini">开始查询</button>
				</view>
				<view class="button-mini">
					<button type="default" form-type="reset" size="mini">清空表单</button>
				</view>
			</view>
		</form>
	</view>
